...
export const Footer = () => {
    return (
        <div>
            <a href="https://www.linkedin.com/in/carlos-ajenjo-19662076/" 
                    target="_blank" 
                    rel="noreferrer">
                <i className="socialnetwork__icon-footer fab fa-linkedin"></i>
            </a>

            <a href="https://twitter.com/caraje_" 
                    target="_blank" 
                    rel="noreferrer">
                <i className="socialnetwork__icon-footer fab fa-twitter"></i>
            </a>

            <a href="https://github.com/Caraje" 
                    target="_blank" 
                    rel="noreferrer">
